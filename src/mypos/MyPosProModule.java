...
public class MyPosProModule extends ReactContextBaseJavaModule {
    ...
    MyPosProModule(ReactApplicationContext reactContext) {
        super(reactContext);
        reactContext.addActivityEventListener(mActivityEventListener);
    }
    public String getName() {
        return "MyPosProModule";
    }

   
    @ReactMethod
     public void makeMyPosProPayment(Double amount, boolean tippingEnabled,  Double tip, String operator, String order, final  Promise promise) {
    ...
    @ReactMethod
    public void makeMyPosProVoidPayment(final  Promise promise){
    ...
    @ReactMethod
    public void makeMyPosProRefund(Double amount, final  Promise promise){
