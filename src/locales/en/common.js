export const commonEN = {
    ...
    postcodeError : "Please Enter a Postal Code.",
    order : "Order",
    logout : "Logout",
    warning : "WARNING",
  ...
  textLogin: "Start with Login !",
  emailAddress: "Email Address",
  password:"Password",
  login: "Login",
  textEmpty: "Currently, You do not have any delivery orders",
  textUser: "Hi, ",
  remainPayment: "Remaining Payment",
  deliveryDetails: "Delivery Details",  
  textOrder: "Order: #",
  textCustomer: "Customer Detail",
  textStore: "Store Information",
  textCustomerName: "Full Name",
  textCustomerPhone: "Phone Number",
  textCustomerAddress: "Delivery Address",
  textStoreName: "Store Name",
  textStorePhone: "Store Phone",
  textStoreAddress: "Store Address",
  textTotal: "Total Payment",
  textTextDelivered: "You have successfully delivered to the customer",
  startDelivery: "Start Delivery",
  textButtonDelivered: "Mark Delivered",
  textConfirm: "Confirm",
  textCancel:"Cancel",
  textRemainPayment: "Remaining Payment",
  textPending: "Pending",
  textLoaded: "Loaded",
  textDelivered: "Delivered",
  textAll: "Show all",
  textDeliveries: "Deliveries", 
  exitAppTitle: "Exit app?",
  exitAppText: "Do you want to exit from the application?",
  yesText: "Exit app",
  noText: "Don't leave",
  "text_information": "Information",
  "text_setting": "More Settings",
  "text_edit_account": "Edit Account",
  "text_dark": "DarkMode",
  "text_language": "Languages",
  "text_title_logout": "Logout",
  "text_description_logout": "Do you want logout?",
  "text_account": "Account",
  "text_show": "Show",
  "text_account_detail": "Account Information",
  "text_first_name": "First Name",
  "text_last_name": "Last Name",
  "text_email": "Email Address",
  "text_phone": "Phone",
  "text_button_edit": "Edit Account",
  "text_phone_required": "Phone*",
  "text_save": "Save",
  "text_home": "Home",
  ...
  "text_account": "Account",
  "text_read": "Read",
  "text_delivery_assign": "Delivery Person Assigned",
  "text_delivery_complete": "Delivery Complete",
  "text_notification": "Notification",
  "text_delivery_address": "Delivery Address",
  "text_total": "Total Payment",
